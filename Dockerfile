...
RUN mkdir /app
COPY --from=build /project/target/cotizador-backend-0.0.1-SNAPSHOT.jar /app/cotizador-backend-0.0.1-SNAPSHOT.jar
WORKDIR /app
CMD "java" "-jar" "cotizador-backend-0.0.1-SNAPSHOT.jar"
